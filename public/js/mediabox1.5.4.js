	...
	Elements.implement({
		...
		*/
		mediabox: function(_options, linkMapper, linksFilter) {
			...
			// Desactivate mediabox if screen < 451
			if (window.getWidth() < 451) {
				links.removeEvents("click").addEvent("click", function(e) {
					e.preventDefault();
				});
				e.stop();
			}
...
window.addEvents({
	domready: Mediabox.scanPage,
	resize: Mediabox.recenter
}); // to recenter the overlay while scrolling, add "scroll: Mediabox.recenter" to the object